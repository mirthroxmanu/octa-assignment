resource "aws_db_instance" "this" {
  ...
  parameter_group_name                  = aws_db_parameter_group.cflo_db_parameter_group.id
  ...
  depends_on                            = [aws_db_parameter_group.cflo_db_parameter_group]
...
resource "aws_db_parameter_group" "cflo_db_parameter_group" {
